...
void uart2_initialize(void)
{
    ...
    ASSERT(gpio_config_compare(UART2_BOARD_TX, GPIOA, 2, GPIO_MODE_ALTERNATE, GPIO_RESISTOR_DISABLED,
                               GPIO_OTYPE_PUSHPULL, GPIO_SPEED_MEDIUM));
    ASSERT(gpio_config_compare(UART2_BOARD_RX, GPIOA, 3, GPIO_MODE_ALTERNATE, GPIO_RESISTOR_DISABLED,
                               GPIO_OTYPE_PUSHPULL, GPIO_SPEED_MEDIUM));
