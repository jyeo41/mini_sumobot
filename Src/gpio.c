...
static gpio_pin_t gpio_board_pins[] = {
    ...
    [I2C2_SCL] =                     {GPIOB, 10, GPIO_MODE_ALTERNATE, GPIO_RESISTOR_DISABLED, GPIO_OTYPE_OPENDRAIN, GPIO_SPEED_HIGH},
    [I2C2_SDA] =                     {GPIOB, 11, GPIO_MODE_ALTERNATE, GPIO_RESISTOR_DISABLED, GPIO_OTYPE_OPENDRAIN, GPIO_SPEED_HIGH},
    [VL53L0X_GPIO1_MIDDLE] =         {GPIOB, 8, GPIO_MODE_INPUT, GPIO_RESISTOR_DISABLED, GPIO_OTYPE_PUSHPULL, GPIO_SPEED_LOW},
    ...
    [TB6612FNG_MOTOR_LEFT_IN1] =     {GPIOC, 8, GPIO_MODE_OUTPUT, GPIO_RESISTOR_DISABLED, GPIO_OTYPE_PUSHPULL, GPIO_SPEED_LOW},
    [TB6612FNG_MOTOR_LEFT_IN2] =     {GPIOC, 9, GPIO_MODE_OUTPUT, GPIO_RESISTOR_DISABLED, GPIO_OTYPE_PUSHPULL, GPIO_SPEED_LOW},
    [TB6612FNG_MOTOR_RIGHT_IN1] =    {GPIOC, 10, GPIO_MODE_OUTPUT, GPIO_RESISTOR_DISABLED, GPIO_OTYPE_PUSHPULL, GPIO_SPEED_LOW},
    [TB6612FNG_MOTOR_RIGHT_IN2] =    {GPIOC, 11, GPIO_MODE_OUTPUT, GPIO_RESISTOR_DISABLED, GPIO_OTYPE_PUSHPULL, GPIO_SPEED_LOW},
};
