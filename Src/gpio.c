...
static gpio_pin_t gpio_board_pins[] = {
    ...
    [ADC3_CHANNEL4] =   {GPIOF, 6, GPIO_MODE_ANALOG, GPIO_RESISTOR_DISABLED},
    [ADC3_CHANNEL5] =   {GPIOF, 7, GPIO_MODE_ANALOG, GPIO_RESISTOR_DISABLED},
    [ADC3_CHANNEL6] =   {GPIOF, 8, GPIO_MODE_ANALOG, GPIO_RESISTOR_DISABLED},
    [ADC3_CHANNEL7] =   {GPIOF, 9, GPIO_MODE_ANALOG, GPIO_RESISTOR_DISABLED},
};
